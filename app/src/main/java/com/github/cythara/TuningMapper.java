...
import com.github.cythara.tuning.BrassBandTuning;
...
class TuningMapper {
    ...
    private static final int BrassBand_TUNING_POSITION=15;
    ...
    static Tuning getTuningFromPosition(int position) {
        switch (position) {
            ...
            case BrassBand_TUNING_POSITION:
                return new BrassBandTuning();
            default:
