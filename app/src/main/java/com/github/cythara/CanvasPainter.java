...
class CanvasPainter {
    ...
    private void drawText(float x, float y, Note note, Paint textPaint) {
        ...
        /**このメソットを再帰的に呼び出すことで文字の書替えを行っている*/
    ...
    /**ピッチのズレに応じて背景色を変えるメソッド*/
    private void setBackground() {
        int color = redBackground;
        String text = "✗";
        /**基準ピッチ内に入っているときは背景を青に変える*/
